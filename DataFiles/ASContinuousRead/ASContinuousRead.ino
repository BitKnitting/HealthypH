...
void loop(){         
  ...
  if (sensor_stringcomplete){                                             //if a string from the Atlas Scientific product has been received in its entirety
    char floatbuf[32];                                                    //Argh - this is ugly!  I was having difficulty with the format of the output strings and getting garbage in results...so
    sensorstring.toCharArray(floatbuf,sizeof(floatbuf));                  //convert to a float and use floats instead...
